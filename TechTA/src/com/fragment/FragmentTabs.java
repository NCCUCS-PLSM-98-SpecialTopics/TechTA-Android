...
public class FragmentTabs extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabManager.addTab(mTabHost.newTabSpec("Fragment1").setIndicator("選擇題",this.getResources().getDrawable(android.R.drawable.ic_dialog_alert)),
        		Fragment1.class, null);
        mTabManager.addTab(mTabHost.newTabSpec("Fragment2").setIndicator("問老師問題",this.getResources().getDrawable(android.R.drawable.ic_input_add)),
        		Fragment2.class, null);
        mTabManager.addTab(mTabHost.newTabSpec("Fragment3").setIndicator("問同學問題",this.getResources().getDrawable(android.R.drawable.ic_input_add)),
